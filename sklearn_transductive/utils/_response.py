...
# TODO (VALIDATE+TEST): allow predict_params to be given to the prediction_method
def _get_response_values(
    ...
    if is_classifier(estimator):
        ...
        y_pred = prediction_method(X, **predict_params)
        ...
        prediction_method = _check_response_method(estimator, response_method)
        y_pred, pos_label = prediction_method(X, **predict_params), None
