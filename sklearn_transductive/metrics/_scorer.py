...
class _MultimetricScorer:
    ...
    def __call__(self, estimator, *args, predict_params=None, **kwargs):
...
# TODO (VALIDATE+TEST): Add specificity to the scorers
for name, metric in [
...
def check_scoring(estimator=None, scoring=None, *, allow_none=False, raise_exc=True):
    ...
    """
    if scoring is None and is_classifier(estimator):
        scoring = "accuracy"

    if scoring is None and is_regressor(estimator):
