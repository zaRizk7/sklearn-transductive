...
class BaseSearchCV(MetaEstimatorMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def score(self, X, y=None, predict_params=None, **params):
        ...
        **params : dict
        ...
        # callable
        score = self.scorer_(self.best_estimator_, X, y, predict_params=predict_params, **score_params)
        if self.multimetric_:
    ...
    def transform(self, X, **params):
        ...
        """
        check_is_fitted(self)
        return self.best_estimator_.transform(X, **params)
    ...
    def inverse_transform(self, X=None, Xt=None, **params):
        ...
        check_is_fitted(self)
        return self.best_estimator_.inverse_transform(X, **params)
    ...
    def _get_routed_params_for_fit(self, params):
        ...
        if _routing_enabled():
            ...
            routed_params = Bunch(
                estimator=Bunch(fit=params, predict=params),
    ...
    def get_metadata_routing(self):
        ...
        router.add(
            scorer=scorer,
            method_mapping=MethodMapping().add(caller="score", callee="score").add(caller="fit", callee="score"),
        )
        router.add(
            splitter=self.cv,
